...
FSpriteRenderer.prototype.render=function(a,b,c){var d=c.getTopLeftPosition(),f=b.getPosition(),e=b.getAngle(),g=b.getCurrentImage(),b=c.getZoom()/b.getImageScale();a.save();var h=(f.x-d.x)*c.getZoom(),c=(f.y-d.y)*c.getZoom();a.translate(h,c);b!=1&&a.scale(b,b);e!=0&&a.rotate(e);a.drawImage(g,0-g.width/2,0-g.height/2);a.restore()};
